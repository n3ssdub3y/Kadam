...
const AboutUs = () => {
  return (
    <div className="container">
      <div className="card">
        <img src="/developers/nakul.jpeg" alt="Person 1" />
        <h3>Nakul</h3>
      ...
      <div className="card">
          <img src="/developers/ness.jpeg" alt="Person 5" />
          <h3>Ness</h3>
      ...
      <div className="card">
        <img src="/developers/lakshuki.jpeg" alt="Person 3" />
        <h3>Lakshuki</h3>
      ...
      <div className="card">
          <img src="/developers/siddhi.jpeg" alt="Person 4" />
          <h3>Siddhi</h3>
      ...
      <div className="card">
        <img src="/developers/pranjal.jpeg" alt="Person 2" />
        <h3>Pranjal</h3>
